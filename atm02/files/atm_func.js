...
export async function atm(balance) {
    let istrue = true;
    while (istrue) {
        ...
        switch (atm.options) {
            ...
            case "Amount Deposit":
                ...
                if (amount.deposit > 0) {
                    ...
                    console.log(chalk.green.bold(`Amount deposited Successfully.\nNew Balance ${balance}`));
                }
                else {
                    console.log(chalk.red.bold("Deposit amount cannot be less than zero or in alphabets!!"));
                }
                break;
            case "Amount Withdraw":
                ...
                if (amountW.withdraw <= balance) {
                    ...
                    console.log(chalk.green.bold(`Amount withdrawn ${amountW.withdraw}.\nNew Balance ${balance}`));
                }
                else {
